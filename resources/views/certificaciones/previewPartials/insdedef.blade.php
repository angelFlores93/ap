<h4>Acta de inscripción de defunción</h4>
<br>
<div class="row">
    <div class="col-lg-2">
...
<div class="row ">
    ...
    <div class="col-lg-6">
        ...
        {!!Form::text('place' ,mb_convert_case($result->FECHA_DEFUN, MB_CASE_TITLE, "UTF-8"),['class'=>'form-control text-center strong-black','id'=>'place','placeholder'=>'Sexo', 'disabled'])!!}
    </div>
</div>
<br>
<div class="row">
